...
const Sidebar: React.FC<SidebarProps> = ({ userType }) => {
  ...
  const contractorLinks = [
    ...
    { name: 'Estimates', path: '/estimates', icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  const customerLinks = [
    ...
    { name: 'Documents', path: '/customer/documents', icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  const links = userType === 'contractor' ? contractorLinks : customerLinks;
  const profilePath = userType === 'contractor' ? '/profile' : '/customer/profile';
  ...
  return (
    ...
    >
      <div className="flex flex-col h-full">
        <div className={`flex items-center ${collapsed ? 'justify-center' : 'justify-between'} h-16 px-4 border-b`}>
          {!collapsed && (
          ...
          <button 
            ...
            className="p-1 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-amber-500"
          >
            {collapsed ? (
        ...
        <div className={`border-t border-gray-200 p-4 ${collapsed ? 'flex justify-center' : ''}`}>
          <Link 
            to={profilePath}
            className={`flex ${collapsed ? 'flex-col items-center' : 'items-center'} hover:bg-gray-50 p-2 rounded-md transition-colors duration-200`}
          >
